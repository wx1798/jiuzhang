...
class UserInfo(models.Model):
    ...
    user = models.CharField(verbose_name='姓名', max_length=16, db_index=True)
...
class Priority(models.Model):
    ...
    优先级
    """
    pid = models.IntegerField(auto_created=True, verbose_name='ID', primary_key=True)
    index = models.CharField(verbose_name='优先级', max_length=3)